...
const replacementGroups = {
    'a': ['а', 'آ', 'ا'], // kz а, ir/ar 
    'b': ['v', 'w', 'б', 'в','ب','ﺑ','و'], // kz бв
    'ç': ['c', 'j', 'ч','ﭻ','چ','ﭼ','ﭺ','ج','ﺞ','ﺟ','ﺝ'], // kz ч ir/ar
    'd': ['д', 'د','ﺩ'], // kz д, ir/ar
    'e': ['ä', 'ə', 'э', 'ә', 'е'], // kz еэә, az ə
    'g': ['ğ', 'г', 'ғ','غ','ﻏ','ﻍ','گ','ﮔ'], //kaz ir/ar
    'ı': ['ы'], // kz ыI
    'i': ['İ', 'і', 'ی','ي'], // kz і, ir/ar 
    'k': ['h', 'x', 'q', 'қ', 'к', 'һ', 'х','ق','ﻕ','ک','ك','ﺦ','خ','ﺧ','ﺥ','ه','ﻩ','ﺢ','ح','ﺣ','ﺡ','ع','ﻋ','ﻉ'], // kz һх, ir/ar
    'l': ['л','ل','ﻟ','ﻝ'], // kz л ir/ar
    'm': ['м','م','ﻣ','ﻡ'], // kz м
    'n': ['н','ن','ﻧ','ﻥ'], // kz н
    'ñ': ['ң'], // kz ң
    'o': ['u', 'ū', 'ұ', 'у', 'о'], // kz ұуо
    'ö': ['ü', 'ү', 'ө'], // kz үө
    'p': ['f', 'ф', 'п','ف','ﻑ','ﻓ','پ','ﭘ'], // kz пф ir/ar
    'r': ['р','ر','ﺭ'], // kz р
    's': ['с', 'ц','س','ﺳ','ﺱ','ث','ﺛ','ﺙ'], // kz сц
    'ş': ['ш','ص','ﺻ','ﺹ','ش','ﺷ','ﺵ'], // kz ш ir/ar
    't': ['т'], // kz т
    'te': ['т','ط','ﻃ','ﻁ','ت','ﺕ','ﺗ'], // kz т, ir/ar
    'y': ['Ý', 'ý', 'ж', 'ё', 'ю','я', 'й'], // kz жёюя
    'z': ['з','ظ','ﻇ','ﻅ','ض','ﺿ','ﺽ','ذ','ﺫ','ز','ﺯ','ژ'], // kz з
  };
